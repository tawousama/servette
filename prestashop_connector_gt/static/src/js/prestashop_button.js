odoo.define('odoo_prestashop2_ept.prestashop_button', function (require) {
"use strict";
        ...
        _toggleBtn: _.debounce(function (ev) {
            ...
            return this._rpc({
                ...
                if(result == 'closed'){
                    ...
                    $('#magento_button_toggle').html('Create more Prestashop instance').css({"background-color":"#ececec","border":"1px solid #ccc"});
                } else {
